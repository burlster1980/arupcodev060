...
<section class="container" id="">
	<div class="rich-text">
		<div class="reveal rich-text__content">
			<h2>Image block</h2>
			<uL>
			<LI><p>Can contain between 2,4 or 5 items</p></li>
...
<section class="container" id="" style="margin-top:200px;">
		<div class="rich-text">
			<div class="reveal rich-text__content">
				...
				<uL><Li><p>Can contain text and image</p></Li>
		...
		<div class="rich-text">
			<div class="reveal rich-text__content">
				...
				<uL><LI><p>Can promote between 1 and 4 items</p></LI>
					...
					<li><p>Content types and call to action defined within dictionary items</p></li>
				</uL>
			</div>
		</div>
	</section>
<section class="container" id="">
						...
						<footer class="preview-card__footer">
							<div class="preview-foot">
								...
								<div class="preview-card__cta preview-card__cta--foot">
									<a href="#"><span class="cta cta--black cta--small cta--right cta--plain"><span class="icon icon-oval" style="background-image: none;"><svg height="42" viewbox="0 0 42 42" width="42" xmlns="http://www.w3.org/2000/svg">
									<circle cx="20" cy="20" fill="none" r="20" stroke="#FFF" stroke-linecap="square" transform="translate(1 1)"></circle></svg></span> <span>Read the full perspective</span></span></a>
								</div>
							</div>
						</footer>
					</div>
	...
	<section class="container" id="">
		<div class="rich-text">
			<div class="reveal rich-text__content">
				...
				<uL><LI><p>Can be standard text module</p></LI>
					<li><p>Can be reconfigured to left align heading and right align body copy (see below)</p></li>
				</uL>
			</div>
		</div>
	</section>
	<section class="container" id="">
        <div class="rich-text">
            <div class="reveal rich-text__content">
                    <p class="intro intro--bold">This is a standard rich text module (NB heading style to be amended to correct H2 format)</p>
                <p>Using our integrated resource management (IRM) tool &ndash; an Arup-designed tool that helps inform sustainable city planning &ndash; we compared different development combinations of building controls and infrastructure delivery. This powerful tool provided an evidence base to help assess options alongside proposed strategies for aspects such as water use, energy production and transport access. It also highlighted how the strategies could work together and presented opportunities for improvement.</p>
            </div>
        </div>
</section>
<section class="container" id="">
        <div class="content-split reveal">
            <h4>We led the planning, left aligned it</h4>
            <p>Over 1,600 Arup specialists &ndash; from transport consultants and tunnel designers to environmental consultants and bridge engineers &ndash; played a key part in identifying the best route, planning and architecture of the new stations, including the monumental refurbishment of St. Pancras.</p>
        </div>
</section>
<section class="container" id="">
		<div class="rich-text">
			<div class="reveal rich-text__content">
				...
				<uL><LI><p>Can add infinite number of items</p></LI>
					<li><p>Can display in half or full bleed modes</p></li>
					<li><p>Can include a caption</p></li>
				</uL>
				<P>NB - note style of pagination on fullbleed carousel is not as per live site</P>
			</div>
		</div>
	</section>
...
<section class="container" id="">
		<div class="rich-text">
			<div class="reveal rich-text__content">
				...
				<uL><LI><p>Can select a single contact / profile to promote</p></LI>
					<li><p>CAn assign dedicated CTA and link</p></li>
					<li><p>CCan enter bespoke phone and email details i.e. override what's provided on profile selected</p></li>
				</uL>
				<P>NB - note style of pagination on fullbleed carousel is not as per live site</P>
			</div>
		</div>
    ...
    <section class="container" id="">
		<div class="rich-text">
			<div class="reveal rich-text__content">
				<h2>Multi contact us</h2>
				<uL><LI><p>Display infinite number of contacts</p></LI>
					<li><p>Assign bespoke job titles at a module level</p></li>
					<li><p>Add a bespoke heading and introduction copy</p></li>
				</uL>
			</div>
		</div>
	</section>
            ...
            <div class="mini-profile mini-profile--icons">
                <div class="mini-profile__pic-wrap">
                    <a href="/our-firm/carol-lemmens" class="mini-profile__link">
                        <img class="mini-profile__pic" src="https://www.arup.com/-/media/arup/images/people/c/carollemmens2019.jpg?h=400&amp;w=400&amp;hash=9FC15D6F56B610704F906458F981FD9FA2D94801" alt="Carol Lemmens" />
                    </a>
                </div>
                <div class="mini-profile__main">
                    <ul class="mini-profile__info-list">
                        <li class="mini-profile__info-item mini-profile__info-item--core mini-profile__info-item--icon">
                            ...
                            <li class="mini-profile__info-item mini-profile__info-item--email mini-profile__info-item--icon">
                                <a href="/cdn-cgi/l/email-protection#96f7f2e0ffe5f9e4efd6f7e4e3e6b8f5f9fb" class="mini-profile__info-link mini-profile__info-link--alt">
                                    <span data-grunticon-embed class="mini-profile__icon icon icon-contact"></span>
                                    <span class="mini-profile__info-content"><span class="__cf_email__" data-cfemail="99f8fdeff0eaf6ebe0d9f8ebece9b7faf6f4">[email&#160;protected]</span></span>
                                </a>
                            </li>
                            <li class="mini-profile__info-item mini-profile__info-item--tel mini-profile__info-item--icon">
                                <a href="tel:+44 (0) 207 755 6642" class="mini-profile__info-link mini-profile__info-link--alt">
                                    ...
                                    <span class="mini-profile__info-content">
                                        +44 (0) 207 755 6642
                                        <br />
                                        <span class="mini-profile__info-meta">Amsterdam, 9/17/2019 9:56:07 AM</span>
                                    </span>
                                </a>
                            </li>
                    </ul>
            ...
            <div class="mini-profile mini-profile--icons">
                <div class="mini-profile__pic-wrap">
                    <a href="/our-firm/orion-fulton" class="mini-profile__link">
                        <img class="mini-profile__pic" src="https://www.arup.com/-/media/arup/images/people/o/orion_fulton_-_san_francisco_office_staff__arup_.jpg?h=450&amp;w=450&amp;hash=2A73BE2F23D159E674FF22C7849EB8C59A447E49" alt="Orion Fulton" />
                    </a>
                </div>
                <div class="mini-profile__main">
                    <ul class="mini-profile__info-list">
                        <li class="mini-profile__info-item mini-profile__info-item--core mini-profile__info-item--icon">
                            ...
                            <li class="mini-profile__info-item mini-profile__info-item--email mini-profile__info-item--icon">
                                <a href="/cdn-cgi/l/email-protection#a5c4c1d3ccd6cad7dce5c4d7d0d58bc6cac8" class="mini-profile__info-link mini-profile__info-link--alt">
                                    <span data-grunticon-embed class="mini-profile__icon icon icon-contact"></span>
                                    <span class="mini-profile__info-content"><span class="__cf_email__" data-cfemail="b2d3d6c4dbc1ddc0cbf2d3c0c7c29cd1dddf">[email&#160;protected]</span></span>
                                </a>
                            </li>
                            <li class="mini-profile__info-item mini-profile__info-item--tel mini-profile__info-item--icon">
                                <a href="tel:+1 415 957 9445" class="mini-profile__info-link mini-profile__info-link--alt">
                                    ...
                                    <span class="mini-profile__info-content">
                                        +1 415 957 9445
                                        <br />
                                        <span class="mini-profile__info-meta">San Francisco, 9/17/2019 1:56:07 AM</span>
                                    </span>
                                </a>
                            </li>
                    </ul>
            ...
            <div class="mini-profile mini-profile--icons">
                <div class="mini-profile__pic-wrap">
                    <a href="/our-firm/jonathan-kinghorn" class="mini-profile__link">
                        <img class="mini-profile__pic" src="https://www.arup.com/-/media/arup/images/people/j/jonathan-kinghorn-2-(2).jpg?h=450&amp;w=450&amp;hash=2A2EFD73CB42EB786F5D6F1D3E4E22DEA227D6BE" alt="Jonathan Kinghorn" />
                    </a>
                </div>
                <div class="mini-profile__main">
                    <ul class="mini-profile__info-list">
                        <li class="mini-profile__info-item mini-profile__info-item--core mini-profile__info-item--icon">
                            ...
                            <li class="mini-profile__info-item mini-profile__info-item--email mini-profile__info-item--icon">
                                <a href="/cdn-cgi/l/email-protection#97f6f3e1fee4f8e5eed7f6e5e2e7b9f4f8fa" class="mini-profile__info-link mini-profile__info-link--alt">
                                    <span data-grunticon-embed class="mini-profile__icon icon icon-contact"></span>
                                    <span class="mini-profile__info-content"><span class="__cf_email__" data-cfemail="a8c9ccdec1dbc7dad1e8c9daddd886cbc7c5">[email&#160;protected]</span></span>
                                </a>
                            </li>
                            <li class="mini-profile__info-item mini-profile__info-item--tel mini-profile__info-item--icon">
                                <a href="tel:+61 (0) 3 9668 5500" class="mini-profile__info-link mini-profile__info-link--alt">
                                    ...
                                    <span class="mini-profile__info-content">
                                        +61 (0) 3 9668 5500
                                        <br />
                                        <span class="mini-profile__info-meta">Melbourne, 9/17/2019 6:56:07 PM</span>
                                    </span>
                                </a>
                            </li>
                    </ul>
            ...
            <div class="mini-profile mini-profile--icons">
                <div class="mini-profile__pic-wrap">
                    <a href="/our-firm/alice-chow" class="mini-profile__link">
                        <img class="mini-profile__pic" src="https://www.arup.com/-/media/arup/images/people/a/hong-kong-office-staff--alice-chowc-arup.jpg?h=450&amp;w=450&amp;hash=5E4AAA299177C55E7AB2FFD29FA2B228A2D8D360" alt="Alice Chow" />
                    </a>
                </div>
                <div class="mini-profile__main">
                    <ul class="mini-profile__info-list">
                        <li class="mini-profile__info-item mini-profile__info-item--core mini-profile__info-item--icon">
                            ...
                            <li class="mini-profile__info-item mini-profile__info-item--email mini-profile__info-item--icon">
                                <a href="/cdn-cgi/l/email-protection#c7a6a3b1aeb4a8b5be87a6b5b2b7e9a4a8aa" class="mini-profile__info-link mini-profile__info-link--alt">
                                    <span data-grunticon-embed class="mini-profile__icon icon icon-contact"></span>
                                    <span class="mini-profile__info-content"><span class="__cf_email__" data-cfemail="5f3e3b29362c302d261f3e2d2a2f713c3032">[email&#160;protected]</span></span>
                                </a>
                            </li>
                            <li class="mini-profile__info-item mini-profile__info-item--tel mini-profile__info-item--icon">
                                <a href="tel:+852 2528 3031" class="mini-profile__info-link mini-profile__info-link--alt">
                                    ...
                                    <span class="mini-profile__info-content">
                                        +852 2528 3031
                                        <br />
                                        <span class="mini-profile__info-meta">Hong Kong, 9/17/2019 4:56:07 PM</span>
                                    </span>
                                </a>
                            </li>
                    </ul>
            ...
            <div class="mini-profile mini-profile--icons">
                <div class="mini-profile__pic-wrap">
                    <a href="/our-firm/elzbieta-cichonska" class="mini-profile__link">
                        <img class="mini-profile__pic" src="https://www.arup.com/-/media/arup/images/people/e/cichonska_elzbieta-(2).jpg?h=450&amp;w=450&amp;hash=F3DFDAA84CCD6048BA338F372B9ED5216F656441" alt="Elzbieta Cichonska" />
                    </a>
                </div>
                <div class="mini-profile__main">
                    <ul class="mini-profile__info-list">
                        <li class="mini-profile__info-item mini-profile__info-item--core mini-profile__info-item--icon">
                            ...
                            <li class="mini-profile__info-item mini-profile__info-item--email mini-profile__info-item--icon">
                                <a href="/cdn-cgi/l/email-protection#8cede8fae5ffe3fef5ccedfef9fca2efe3e1" class="mini-profile__info-link mini-profile__info-link--alt">
                                    <span data-grunticon-embed class="mini-profile__icon icon icon-contact"></span>
                                    <span class="mini-profile__info-content"><span class="__cf_email__" data-cfemail="375653415e4458454e77564542471954585a">[email&#160;protected]</span></span>
                                </a>
                            </li>
                            <li class="mini-profile__info-item mini-profile__info-item--tel mini-profile__info-item--icon">
                                <a href="tel:+48 (0) 22 455 4554" class="mini-profile__info-link mini-profile__info-link--alt">
                                    ...
                                    <span class="mini-profile__info-content">
                                        +48 (0) 22 455 4554
                                        <br />
                                        <span class="mini-profile__info-meta">Warsaw, 9/17/2019 10:56:07 AM</span>
                                    </span>
                                </a>
                            </li>
                    </ul>
            ...
            <div class="mini-profile mini-profile--icons">
                <div class="mini-profile__pic-wrap">
                    <a href="/our-firm/steven-lloyd" class="mini-profile__link">
                        <img class="mini-profile__pic" src="https://www.arup.com/-/media/arup/images/people/s/steven-lloyd--transcation-advice-ukc-daniel-imadearup.jpg?h=450&amp;w=450&amp;hash=77991F49FAE0FD63588939FBAEB85E9D8F2537D4" alt="Steven Lloyd" />
                    </a>
                </div>
                <div class="mini-profile__main">
                    <ul class="mini-profile__info-list">
                        <li class="mini-profile__info-item mini-profile__info-item--core mini-profile__info-item--icon">
                            ...
                            <li class="mini-profile__info-item mini-profile__info-item--email mini-profile__info-item--icon">
                                <a href="/cdn-cgi/l/email-protection#08696c7e617b677a7148697a7d78266b6765" class="mini-profile__info-link mini-profile__info-link--alt">
                                    <span data-grunticon-embed class="mini-profile__icon icon icon-contact"></span>
                                    <span class="mini-profile__info-content"><span class="__cf_email__" data-cfemail="badbdeccd3c9d5c8c3fadbc8cfca94d9d5d7">[email&#160;protected]</span></span>
                                </a>
                            </li>
                            <li class="mini-profile__info-item mini-profile__info-item--tel mini-profile__info-item--icon">
                                <a href="tel:+44 (0) 161 228 2331" class="mini-profile__info-link mini-profile__info-link--alt">
                                    ...
                                    <span class="mini-profile__info-content">
                                        +44 (0) 161 228 2331
                                        <br />
                                        <span class="mini-profile__info-meta">Manchester, 9/17/2019 9:56:07 AM</span>
                                    </span>
                                </a>
                            </li>
                    </ul>
...
<section class="container" id="">
		<div class="rich-text">
			<div class="reveal rich-text__content">
				...
				<uL><LI><p>Can display an infinite number of items</p></LI>
					<li><p>Entire module can have a dedicated background image or grey background colour</p></li>
					<li><p>Each item can have a bespoke background image or select from Arup 'grey' background colours</p></li>
					<li><p>Title, strapline and link are definable at the module level</p></li>
				</uL>
			</div>
		</div>
	</section>
...
<div class="inpagenav-item" id="C4619586082F43D69CC9E63A3C6601CE">
    <a href="/expertise/services/advisory-services/strategy-and-insights" class="linkfill">
        <div class="inner">
            ...
            <p>
                Making change work for you by realising new opportunities
            </p>
    ...
    [id="BB88AFA79CC84BAC9818220B79A338B8"] .inner .background.background-image {
        background-image: url(https://www.arup.com/-/media/arup/images/expertise/services/advisory-services/navigation/financenavigation.jpg?h=230&amp;w=390&amp;hash=FC0DF7401F141CAB4FBE4D718B930F733FD1C244) !important;
    }
</style>

<div class="inpagenav-item" id="BB88AFA79CC84BAC9818220B79A338B8">
    <a href="/expertise/services/advisory-services/finance-and-economics" class="linkfill">
        <div class="inner">
                <div class="background background-image"></div>
            <div class="background background-color"></div>
            <h4>
    ...
    [id="805035DA0DC1410A82D6EAB3E59E3E86"] .inner .background.background-image {
        background-image: url(https://www.arup.com/-/media/arup/images/expertise/services/advisory-services/navigation/programmesnavigation.jpg?h=230&amp;w=390&amp;hash=CDDAC0B0E36E5BF932FDC60C8053EA411A82781E) !important;
    }
</style>
...
<div class="inpagenav-item" id="805035DA0DC1410A82D6EAB3E59E3E86">
    ...
    [id="346D11989F484C67805DDDC0223F0073"] .inner .background.background-image {
        background-image: url(https://www.arup.com/-/media/arup/images/expertise/services/advisory-services/navigation/assetsnavigation.jpg?h=230&amp;w=390&amp;hash=5DD8ECEC1F4B6D045EB329E1B94C5F4DF709F6FC) !important;
    }
</style>
...
<div class="inpagenav-item" id="346D11989F484C67805DDDC0223F0073">
    <a href="/expertise/services/advisory-services/assets-and-operations" class="linkfill">
        <div class="inner">
            ...
            <p>
                Managing assets and facilities for better business performance 
            </p>
            <div class="expertise-services__cta cta cta--black cta--small">
                <span data-grunticon-embed class="icon icon-oval"></span>
            </div>
    ...
    [id="F79684335D2B457DA7CBE6FBFBF3C678"] .inner .background.background-color {
        background-color: #f2f2f2 !important;
    }
    [id="F79684335D2B457DA7CBE6FBFBF3C678"] .inner .background.background-image {
        background-image: url(https://www.arup.com/-/media/arup/images/expertise/services/advisory-services/navigation/peoplenavigation.jpg?h=230&amp;w=390&amp;hash=5288F26753AEE2A790A5D95153D1F9A524BB8AB4) !important;
    }
</style>
...
<div class="inpagenav-item" id="F79684335D2B457DA7CBE6FBFBF3C678">
    <a href="/expertise/services/advisory-services/people-and-organisations" class="linkfill">
        <div class="inner">
            ...
            <p>
                Getting the best from your people by responding to change&#160;
            </p>
            <div class="expertise-services__cta cta cta--black cta--small">
                <span data-grunticon-embed class="icon icon-oval"></span>
            </div>
    ...
    [id="87C8544E9A314175A1519B8DE1EC7BF3"] .inner .background.background-color {
        background-color: #ebebeb !important;
    }
    [id="87C8544E9A314175A1519B8DE1EC7BF3"] .inner .background.background-image {
        background-image: url(https://www.arup.com/-/media/arup/images/expertise/services/advisory-services/navigation/sustainablenavigation.jpg?h=230&amp;w=390&amp;hash=D763FD895F1C444918EC8ABF4B71E8E6315BA2C6) !important;
    }
</style>

<div class="inpagenav-item" id="87C8544E9A314175A1519B8DE1EC7BF3">
    <a href="/expertise/services/advisory-services/sustainable-futures" class="linkfill">
        <div class="inner">
                <div class="background background-image"></div>
            <div class="background background-color"></div>
            <h4>
            ...
            <p>
                Define and design a better future for your business 
            </p>
            <div class="expertise-services__cta cta cta--black cta--small">
                <span data-grunticon-embed class="icon icon-oval"></span>
            </div>
...
<section class="container" id="">
		<div class="rich-text">
			<div class="reveal rich-text__content">
				<h2>Video</h2>
				<uL><LI><p>Can display video from youtube, vimeo and kaltura</p></LI>
					<li><p>Can add a caption</p></li>
				</uL>
			</div>
		</div>
	</section>
...
<section class="container" id="">
		<div class="rich-text">
			<div class="reveal rich-text__content">
				<h2>Perspective banner</h2>
				<uL><LI><p>Can theoretically be used anywhere</p></LI>
					<li><p>Can define what content is included in search bar and whether or not search bar is displayed</p></li>
					<li><p>Can choose what content to include in counts - this is based on 'theme' total i.e. total number of items tagged with matching theme</p></li>
				</uL>
			</div>
		</div>
	</section>
    ...
    <div class="page-hero__inner">
        <div class="page-hero__copy">
            <div class="hero-text">
                ...
                <h1 class="hero-text__title">Cities</h1>
                <div class="hero-text__copy-wrap">
                    <p class="hero-text__copy">With the world’s urban populations growing at a rapid pace, we explore the issues affecting our cities today and how we are shaping them for the future.</p>
                </div>
                <div class="hero-text__extra">
                    <ul class="mini-info">
                        <li class="mini-info__item">167 Articles</li>
                        <li class="mini-info__item">35 Publications</li>
                    </ul>
                </div>
            </div>
        </div>
    </div>
    <div class="page-hero__pic"   style="background-image: url('https://www.arup.com/-/media/arup/images/perspectives/themes/cities/cities.jpg?h=833&amp;w=2000&amp;hash=92FEAA69F967B8CB88E6C90759DF028389442786')"  >
            <span class="page-hero__pic--mobile" style="background-image: url('https://www.arup.com/-/media/arup/images/perspectives/themes/transport/transport.jpg?h=833&amp;w=2000&amp;hash=6FF9B9F5B2474DF43F41F344948A16654153E1E6')"></span>
    </div>
</div>
<div class="container">
    <div class="page-search js-search-trigger" data-search-filter="Perspective|Publication" data-amount-per-section="3" data-search-placeholder="Search articles and publications">
