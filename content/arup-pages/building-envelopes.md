                ...
                <div class="col col__main">
                    <div class="page-info">
                        <div class="page-info__title feature-title">
                            ...
                            <h1 class="feature-title__title">Building Envelopes</h1>
                        </div>
                        <div class="page-info__content">
                            <p class="page-info__copy">Arup works on every aspect of building envelopes, from building envelope design through to the implementation of facdes and the development of modern green building envelopes.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="container" id="">
        <div class="rich-text">
            <div class="reveal rich-text__content">
               <p>The envelope is the building's outer skin and its interface to the city. It is fundamental to its successful energy performance, fulfilling architectural and aesthetic requirements on the outside and improving comfort levels (health & wellbeing) for the occupants on the inside.
                </p>
                <p>Arups works on every aspect of the building envelope and broad range of expertise means we are able to support clients regardless of their evolving challenges.</p>
            </div>
        </div>
    </section>
    ...
    <div class="dynamic-feat reveal" style="padding-bottom:0">
            <header class="dynamic-feat__header">
                <div class="dynamic-feat__title-wrap">
                    <h4 class="dynamic-feat__title">Discover our expertise</h4>
                </div>
            </header>
        <div class="dynamic-feat__list">
            <ul class="up-list">
<li class="up-list__item">
    <a href="/arup-pages/building-envelopes/building-envelope-design/" class="preview-card ">
        ...
        <div class="preview-card__content image" style="background-color: transparent;">
            <div class="preview-card__main" style="position: relative;z-index: 3">
                <div class="preview-copy">
                    <h3 class="preview-copy__title ">Building Envelope Design</h3>
                    <div class="preview-copy__copy-wrap">
                            <p class="preview-copy__copy">Our multidisciplinary services for building envelope designs and the upgrade of existing envelopes help us to enhance environmental conditions in urban settings</p>
...
<li class="up-list__item">
    <a href="/arup-pages/building-envelopes/green-envelope-design/" class="preview-card ">
            <header class="preview-card__header preview-card__header--pic">
                <!--<div class="preview-card__pic" style="background-image: url('/-/media/arup/images/expertise/services/smartcitiesmore-london--overall-viewsc-daniel-clements.jpg?h=1125&amp;w=2000&amp;hash=D76D9D74A1F3C88323C3521BE0BF811AD189143B');"></div>-->
            </header>
    ...
    filter: grayscale(100%);position: absolute;top:0;bottom:0;left: 0;right:0;"></div>
        <div class="preview-card__content image" style="background-color: transparent;">
            <div class="preview-card__main" style="position: relative;z-index: 3">
                <div class="preview-copy">
                    <h3 class="preview-copy__title ">Green Building Envelopes</h3>
                    <div class="preview-copy__copy-wrap">
                            <p class="preview-copy__copy">We offer green building envelopes: moss walls, tree façades, and urban agriculture initiatives such as vertical farming, beehives and wildlife corridors, which help improve air quality.</p>
                            <span class="cta cta--black cta--lg cta--right cta--plain">
                        <span data-grunticon-embed class="icon icon-oval"></span>
                        <span></span>
                    </span>
...
<li class="up-list__item">
    <a href="/arup-pages/building-envelopes/facade-engineering/" class="preview-card ">
            <header class="preview-card__header preview-card__header--pic">
                <!--<div class="preview-card__pic" style="background-image: url('/-/media/arup/images/expertise/services/smartcitiesmore-london--overall-viewsc-daniel-clements.jpg?h=1125&amp;w=2000&amp;hash=D76D9D74A1F3C88323C3521BE0BF811AD189143B');"></div>-->
            </header>
    ...
    filter: grayscale(100%);position: absolute;top:0;bottom:0;left: 0;right:0;"></div>
        <div class="preview-card__content image" style="background-color: transparent;">
            <div class="preview-card__main" style="position: relative;z-index: 3">
                <div class="preview-copy">
                    <h3 class="preview-copy__title ">Facade Engineering and Design</h3>
                    <div class="preview-copy__copy-wrap">
                            <p class="preview-copy__copy">Some short sweet introductory copy to go here and summarise what the user will find</p>
                            <span class="cta cta--black cta--lg cta--right cta--plain">
                        <span data-grunticon-embed class="icon icon-oval"></span>
                        <span></span>
                    </span>
...
<li class="up-list__item">
    <a href="/arup-pages/building-envelopes/facade-access/" class="preview-card ">
            <header class="preview-card__header preview-card__header--pic">
                <!--<div class="preview-card__pic" style="background-image: url('/-/media/arup/images/expertise/services/smartcitiesmore-london--overall-viewsc-daniel-clements.jpg?h=1125&amp;w=2000&amp;hash=D76D9D74A1F3C88323C3521BE0BF811AD189143B');"></div>-->
            </header>
    ...
    filter: grayscale(100%);position: absolute;top:0;bottom:0;left: 0;right:0;"></div>
        <div class="preview-card__content image" style="background-color: transparent;">
            <div class="preview-card__main" style="position: relative;z-index: 3">
                <div class="preview-copy">
                    <h3 class="preview-copy__title ">Facade Access and BMU Consulting</h3>
                    <div class="preview-copy__copy-wrap">
                            <p class="preview-copy__copy">Some short sweet introductory copy to go here and summarise what the user will find</p>
                            <span class="cta cta--black cta--lg cta--right cta--plain">
                        <span data-grunticon-embed class="icon icon-oval"></span>
...
Some intro copy probably goes here to explain why you're hitting case studies - i.e. Discover how our Building Envelope experts are helping business transform their performance, delivering advanced solutions and strategies etc. NOTE these examples would be drawn from across the whole Building Envelope experience.</P>
            </div>
        </div>
    </section>
    <section class="container">
...
<section class="learn-more learn-more--large reveal" style="background-image: url(https://www.arup.com/-/media/arup/images/projects/l/london-waste-and-recycling-board-circular-economy/henrybe229092forarupcom.jpg?h=1125&la=en&w=2000&hash=3C0B43BC400C271CAD0B8EA608FE571D679D1434)">
    <div class="learn-more__inner" >
        ...
        <a href="#" class="cta cta--small cta--mono" style="font-size:1.5em;">
            ...
            <span class="cta__text">See all our projects</span>
        </a>
    </div>
</section>
