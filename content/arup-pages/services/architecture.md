...
<!--<section class="container" id="">
        <div class="rich-text">
            <div class="reveal rich-text__content">
               <h2>Elegant design. Enduring impact.</h2><P> 
Whether it is early stage advisory work or completed buildings and infrastructure, our approach to architecture requires an open exploration, conducted by many different practitioners. Our approach combines performance and aesthetics into a socially responsible and cost-effective solution. Together, we design outcomes and impacts, not just buildings. </P>
        	</div>
    	</div>
	</section>
<section class="split-pic  ">
    <div class="split-pic__pic-wrap split-pic__pic-wrap--frame">
        <div class="split-pic__pic split-pic__pic--desktop" style="background-image: url('/images/arup-pages/architecture/test2.gif')"></div>
        <div class="split-pic__pic split-pic__pic--mobile" style="background-image: url('')"></div>
    ...
    <div class="split-pic__content">
        <div class="split-pic__inner">
            <div class="split-pic__copy">
                <h3 class="h4"></h3>
                <p>That means making architectural choices that reflect how will people live and work tomorrow, understanding their changing preferences and priorities. It means buildings that help clients to go beyond net-zero carbon emissions, embracing emerging ideas like regenerative design. This focus on the widest beneficial impacts guided our work on Copenhagen’s Cityringen metro line, whose design reflects local neighbourhoods’ textures and characters, while helping the Danish capital to decarbonise public transport. </p>
                    <h5></h5>
                    <hr />
...
<!--<section class="split-pic  ">
    <div class="split-pic__pic-wrap split-pic__pic-wrap--frame">
        <div class="split-pic__pic split-pic__pic--desktop" style="background-image: url('/images/arup-pages/architecture/test2.gif')"></div>
        <div class="split-pic__pic split-pic__pic--mobile" style="background-image: url('/-/media/arup/images/newsandevents/news/a/arups-new-melbourne-office-puts-quality-and-sustainability-on-show/one-melbourne-quarter-internal--arup-2000x1125.jpg?mw=720&amp;hash=F2775437DA589E34E8259B3308938978')"></div>
        <p class="split-pic__caption"></p>
    </div>
    <div class="split-pic__content">
        <div class="split-pic__inner">
            <div class="split-pic__copy">
                <h3 class="h4"></h3>
                <p>We have a global reputation for producing high-performance and technically rigorous architecture across both large-scale public and private sector industries, including:</p><ul><li>
Transport infrastructure
</li><LI>Science and industry facilities
</li><li>Sports venues
</li><li>Commercial buildings
</li></ul>
                    <h5></h5>
                    <hr />
                    <ul class="list list--links">
            ...
            <div class="preview-card__main">
                <div class="preview-copy">
                    <a href="/perspectives/if-you-know-the-right-questions-and-understand-the-risks-data-can-help-build-better-cities" class="preview-copy__toplink">
                        ...
                        <h3 class="preview-copy__title ">Etihad Stadium, Manchester</h3>
                    ...
                    <ul class="mini-profile__info-list">
                        <li class="mini-profile__info-item mini-profile__info-item--core mini-profile__info-item--icon">
                            <a href="/our-firm/alice-chow" class="mini-profile__info-link">
                                <span data-grunticon-embed class="mini-profile__icon icon icon-profile"></span>
                                <span class="mini-profile__info-content">
                                    <h4 class="mini-profile__name">Karma Barfungpa
                                  </h4>
