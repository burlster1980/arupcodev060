---
title: "Online Collarboration"
date: 2020-06-10T22:25:03+01:00
draft: false
type: perspective
---
<section class="fullbleed service-banner fullbleed--hero fullbleed--project">
    ...
    <div class="progressiveMedia">
        ...
        <img src="https://www.arup.com/-/media/arup/images/expertise/services/digital/virtual-engage/arup-engage-banner.jpg?h=1125&w=2000&hash=114F936EB302D1A136B3F7C891BBD7CD" class="mainImg loading active" alt="" width="2000" height="1125" disablewebedit="False">;
    </div>
                ...
                <div class="col col__main">
                    <div class="page-info">
                        <div class="page-info__title feature-title">
                            ...
                            <h1 class="feature-title__title">Virtual collaboration</h1>
                        </div>
                        <div class="page-info__content">
                            <p class="page-info__copy">Share your objectives, reach more people, empower decision-making. </p>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="utility-bar sticky">
    <div class="container utility-bar__inner">
        <div class="utility-bar__breadcrumb">
            <p class="utility-bar__page-title">Virtual collaboration</p>
...
<section class="highlight-section" style="background-color:#e2e2e2;padding:50px 0;">
        ...
        <div class="rich-text">
            <div class="reveal rich-text__content">
                ...
                <p class="intro">Page would be similiar in scope to recently completed Perspective - provides an overview of the services that are offered in this realm including:</p>
                	<ul><li>
                		<P>Arup Virtual Engage (slide 4 - existing page on site)</P>
                	</li>
                		<lI><P>Digital project management tools (slide 19) and remote project facilitation (slide 20)</P></lI>
                		<li><P>Likely to include Experience studio (not mentioned in deck - but will shortly have a dedicated page on the website)</P></li>
