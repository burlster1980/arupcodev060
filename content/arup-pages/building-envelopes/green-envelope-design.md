    ...
    <section class="container" id="">
        <div class="rich-text">
            <div class="reveal rich-text__content">
               <p>With cities getting denser all the time, there is less and less room for green infrastructure. Yet green spaces are vital to make a city more attractive and more resilient. As an infrastructural element, greening helps to reduce unnecessary energy consumption.</p><p>
Green envelopes improve air quality and reduce pollution by filtering fine particles out of the air. Not only that. They also reduce heat island effects and noise levels (acoustics).</p><p>
We offer a tremendous range of green building envelopes (landscape architecture): moss walls, tree façades, and urban agriculture initiatives such as vertical farming, beehives and wildlife corridors, which all help to deliver better air quality. And that's not all. Capturing the renewable energy by using bio-reactive cladding components such as SolarLeaf (Links to project page SolarLeaf) and the Bio Energy Façade (Link to project page Bioenergy Façade) can improve sustainability in built-up environments.
(Possible projects: California Academy of Sciences, USA https://www.arup.com/projects/california-academy-of-sciences?query=california%20academy including figures and quote, Living Wall Lite, UK https://www.arup.com/news-and-events/arup-and-grosvenor-champion-new-living-wall-technology?query=living%20wall with figures, quotes and great photos in the assset bank, Capita Green, Singapore https://www.arup.com/projects/capitagreen?query=cap with new photos)
Green roofs greatly improve water management too, enabling stormwater retention with timely release to public drainage systems and making it unnecessary to build expensive infrastructural stormwater facilities.</p><P>
“We develop green building envelope concepts that are tailored to local and climatically relevant conditions and achieve manifold positive effects that complement each other in the best possible way towards a healthier and more sustainable built environment. ”</P><P>
Rudi Scheuermann, Arup Fellow, Global Leader Building Envelope Design </P>
(Include podcast: Rudi Scheuermann on Designing Green Envelopes https://engineeringmatters.reby.media/2019/03/08/designing-green-buildings/)
</p><h2>Intensive global research</h2><p>
Experts from different disciplines around the globe have aimed to quantify the benefits of green building envelopes in terms of their potential to mitigate urban noise, air pollution and heat. This extensive research (research) has enabled us to make the effects in terms of profitability predictable and measurable.
</p>
            </div>
        </div>
    </section>
