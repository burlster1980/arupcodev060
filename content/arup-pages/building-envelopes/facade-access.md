    ...
    <section class="container" id="">
        <div class="rich-text">
            <div class="reveal rich-text__content">
               <p>Building Maintenance Unit (BMU) and Façade Access is a specialist service that represents an important niche of any development, providing bespoke possibilities for optimised access systems to unique facades. Close collaboration of Façade Access with building envelope design is critical to allow for the future proofing of any development. This service is often awarded at a later stage of a project, resulting in restricted possibilities for an optimised façade access system and an increase in cost to the client, thus engaging early in the design process will be highly beneficial.</p><P>
As a global engineering industry leader, Arup has identified this significant gap within the building market and now provides a fully integrated BMU and Façade Access Consultancy service to our clients.</P><p>
Our global specialist team is one of the market leaders for BMU and Façade Access Consultancy. Our global reach means that we bring to our clients the invaluable experience of working with major contractors in the market, as well as knowledge of the best access systems - including building maintenance units, abseiling systems, cherry pickers, temporary and permanent access systems. This ensures that the strategies developed are tailored for the specific requirements from the Client, allowing for the best possible outcome.</p><p>
Our portfolio of projects ranges from bridges, airports, stadiums traditional and industrial structures to residential and commercial high-rise buildings. We specialise in complex buildings up to mega tall towers, as well as being involved in innovative new design features such as maintenance of green walls.  Drawing upon this diversity of experience provides a solid resource for exploring project specific and unique design solutions while ensuring success with proven systems.</p><p>
(Project examples: Taoyuan International Airport Terminal 3 https://www.arup.com/projects/taoyuan-internationalairport-terminal-3 - together with RSHP Architects Arup developed a full coordinated design package including BIM 300, Harbour Bridge Sidney – see attached information, CTF Tianjin http://legacy.skyscrapercenter.com/tianjin/tianjin-ctf-finance-centre/310/ - fully integrated design with close coordination with Architects and Façade Engineer to fit the BMUs within the mega tall tower, see APPENDIX 1)
A key aspect of the timely consideration of BMU strategies is that we can optimise project and operational costs by ensuring the building is accessible and can be safely and efficiently maintained whilst meeting all project performance and regulatory requirements.  
Our advice is unbiased as we are independent of any one manufacturer. </p>
