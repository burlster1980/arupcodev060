                ...
                <div class="col col__main">
                    <div class="page-info">
                        <div class="page-info__title feature-title">
                            ...
                            <h1 class="feature-title__title">Facade engineering</h1>
                        </div>
                        <div class="page-info__content">
                            <p class="page-info__copy">We are specialists in the design and engineering of cladding focusing on architecture, building physics, structure, geometry, glass design, rope access and software development. </p>
                        </div>
                    </div>
                </div>
            </div>
