...
<section id="one" class="section fullbleed--hero fullbleed fullbleed--video banner__fullheight">
    ...
    <div style="position: absolute;top:50%;transform: translate(-50%, -50%);left:50%;width:100%;max-width:1160px;z-index: 2;display: flex;align-items: center;justify-content: center;flex-direction: column;">
    		<div>
...
<!--<section class="section section-text-over-media section-text-over-image section-text-over-media-127455 has-text viewport-height section-animate">
	<div class="text text-over-media-inner">
		<p class="largeText">At 55km long, and including 3 cable-stayed bridges, 2 artificial islands and 1 tunnel, the Hong Kong Zhuhai Macua Bridge (HZMB) is the world’s longest sea crossing. </p>
		<p class="largeText">It connects the cities of Hong Kong and Macau to mainland China, bringing 10m people closer together.</p>
		<p class="largeText">Working with clients and partners, over 300 Arup staff from around the world were involved in realising this engineering wonder.</p>
	</div>
	<div class="background-overlay"></div>
	<div class="section-background section-background-fixed">
		<picture class="section-background-image text-over-media-background-image">
        <img src="/images/arup-pages/hzmb/aerial-view-hzmb.jpg" data-object-fit="cover" data-autoscale-content-ratio="1.77777777778">
      </picture>
	</div>
</section>-->
<!-- test stat aligned to text -->
<!--<section class="background__ultra-light section__animate section" id="storyOne"> 
	<div class="left__right animate-content-steve">
		<div class="left__column">
			<div class="stat__container ">
				<span class="statNumber" id="scoreOne">0</span>
				<span class="statDescription" id="scoreOneDescription">years to complete</span>
		...
		<div class="right__column column__padding left">
			<div class="campaign__text-container " style="">
				<h2>Design</h2>
				<p>Designing the world's longest sea crossing presented challenges beyond sheer scale and ambition. </p>
				<p>Firstly the environment. Design needed to consider busy shipping lanes, the impact of typhoons or earthquakes, to protecting wildlife such as the Chinese white dolphin.
				</p>
				<p>Secondly, the locations. The crossing would need to deliver economic benefits to each city - as well as consider cultural differences such as the side of the road users in location drive on.
				</p>
				<P>Thirdly, the need to meet client demands for beauty. As the world’s longest sea crossing, it would be visible from land, sea and air. This meant its design must demand attention.</p>
				<P>Achieving this meant thinking differently, the ability to define new solutions and challenge established practices. It would represent the ethos of Arup's total design philosophy.</P>
			</div>
		</div>
	</P>
</section>-->
...
<!--<section class="background__ultra-light campaign section" id="storyTwo">
	<div class="left__right animate-content-steve" style="min-height:716px;">
		<div class="left__column">
			<div class="stat__container ">
				<div>
				<span class="statNumber measure" id="scoreTwo">0</span>
		...
		<div class="right__column column__padding left" style="">
			<div class="col col__main">
			<h2>The main crossing</h2>
			<p>
			The main section of the HZMB comprises three navigation channel bridges: Jiuzhou, Jianghai and Qingzhou.
...
<!-- begin first pin carousel -->
<!--<section class="fullbleed fullbleed--secondary fullbleed--hero section" id="carouselOne">
	<div class="progressiveMedia ">
		<div class="something">
            <img src="/images/arup-pages/hzmb/jiuzhou-bridge-one.jpg" class="mainImg loading active fix-image" id="imageOne" alt="" width="2000" height="1125" disablewebedit="False">
            	<div class="caption__container">
            		<div class="image-caption" id="captionOne">The Jiuzhou bridge - designers sort to create towers with unique shapes to establish a visual affinity</div>
            	</div>
            <img src="/images/arup-pages/hzmb/sail-columns-two.jpg" class="mainImg loading active fix-image" id="imageTwo" alt="" width="2000" height="1125" disablewebedit="False">
            <div class="caption__container">
            		<div class="image-caption" id="captionTwo">The Jiuzhou bridge - single column peers were used to support the structure with piles buried in the seabed. Naeem Hussain's vision of a sailing boat's mast can clearly be seen</div>
            	</div>
        </div>
    </div>
</section>-->
	...
	<div class="container container--3col ">
    	...
    	<div class="col col__main">
			<!--<h2>Connecting three cities</h2>-->
				...
				<p>
				We helped design and construct many of the links and crossing facilities that meld these connections together. Each required innovative solutions and creative thinking.
				</p>
				<p>
				For example, we proposed locating the Hong Kong Boundary Crossing Facility (BCF) on an artificial island to ensure smooth connectivity with the HZMB and vital infrastructure such as Hong Kong airport. 
				</p>
				<p>
				To reduce the environmental impact, our design used a non-dredged solution. This meant leaving marine sediment in place, and reduced construction traffic. Both reduced the impact on the sea and its occupants.
				</P>
    	</div>
    </div>
</section>
<!--<section class="background__ultra-light campaign section__animate section" id="storyThree">
	<div class="left__right animate-content-steve">
		<div class="left__column">
			<div class="stat__container ">
					<div>
				...
				<span class="statDescription" id="scoreThreeDescription">reduction in journey length between Zhuhai and Hong Kong</span>
			</div>
		</div>
		<div class="right__column column__padding left">
			<div class="col col__main">
...
<section class="fullbleed fullbleed--secondary fullbleed--hero full__height" id="carouselTwo">
	<div class="progressiveMedia ">
		<img src="/images/arup-pages/hzmb/hk-artificial-island.jpg" class="mainImg loading active fix-image" id="imageThree" alt="" width="2000" height="1125" disablewebedit="False">
        <div class="caption__container">
        	<div class="image-caption" id="captionThree">The Hong Kond Boundary Crossing Facility under construction. It was located on a reclaimed, artificial island of about 150 hectares. Every effort was made during design to reduce the impact on the environment</div>
        </div>
        <img src="/images/arup-pages/hzmb/hzmb-hkbcf.jpg" class="mainImg loading active fix-image" id="imageFour" alt="" width="2000" height="1125" disablewebedit="False">
        <div class="caption__container">
        	<div class="image-caption" id="captionFour">The completed Hong Kong Boundary Crossing Facility. It includes facilities for cargo and passenger clearing as well as vehicle inspections</div>
        </div>
    </div>
</section>
<section class=" section background__ultra-light column__padding" id="storyFour">
	<div class="container container--3col ">
    	<div class="col col__contact" id="sidebar" data-limit="#featured-content">
    		<!-- empty -->
    	</div>
...
<!--<section class="background__ultra-light campaign section__animate section" id="storyFour">
	<div class="left__right animate-content-steve">
		<div class="left__column">
			<div class="stat__container ">
				<div>
...
<!--<div class="block background__ultra-light">
	<section class="container container--3col padding">
		<div class="col col__main">
			<p>
			In Hong Kong, we aided the design and delivery of the Hong Kong Link Road. 12km long and formed of 9.4kms of viaduct as well as a 1km tunnel, this connected the Boundary Crossing Facility with the main HZMB.
			</p>
			<P>As well as economic considerations, such as ensuring improved links with Hong Kong International Airport, this link route not only needed to help alleviate local traffic pressures, but needed to account for important local differences. Hong Kongers traditionally drive on the left. As the HZMB would be located in mainlaind Chinese waters, it would be right hand drive. The link road where therefore need to successful convey drives from left to right and back again for the reverse journey.</P>
		</div>
	</section>
</div>-->
<section class="fullbleed fullbleed--secondary fullbleed--hero full__height" id="carouselThree">
	<div class="progressiveMedia ">
		<img src="/images/arup-pages/hzmb/hk-link-road-and-tunnel.jpg" class="mainImg loading active fix-image" id="imageFive" alt="" width="2000" height="1125" disablewebedit="False">
          	<div class="caption__container">
          		<div class="image-caption" id="captionFive">The Hong Kong Link road can under construction. The 9.4km viaduct descends into a tunnel. Here the tunnel's artifical island entrance can be seen under construction</div>
           	</div>
        <img src="/images/arup-pages/hzmb/hk-link-road-hkia.jpg" class="mainImg loading active fix-image" id="imageSix" alt="" width="2000" height="1125" disablewebedit="False">
        <div class="caption__container">
           	<div class="image-caption" id="captionSix">S-curved alignment inside the airport Channel to avoid close to the touchdown zone of the airport runway and the Government Flying Service headquarters</div>
           	</div>
        <img src="/images/arup-pages/hzmb/hk-link-road-sunset.jpg" class="mainImg loading active fix-image" id="imageSeven" alt="" width="2000" height="1125" disablewebedit="False">
        <div class="caption__container">
          	<div class="image-caption" id="captionSeven">The completed link road with tunnel entrance in the background</div>
        </div>
    </div>
</section>
<div class="block background__ultra-light">
	<section class="container container--3col padding">
		<div class="col col__main">
			<h2>A record breaking tunnnel</h2>
			<p>
			When it came to connecting parts of Hong Kong – including Hong Kong International Airport – with the HKBCF, designers faced a new set of challenges. The link road, officially known as the Tuen Mun-Chek Lap Kok Link, includes a combination of viaducts and a sub-sea tunnel.
			</p>
			<p>
			Arup provided multidisciplinary design for this tunnel. Working with Dragages Bouygues Joint Venture, we helped deliver a safe and sustainable design which included the use of a world-record external diameter of 17.6m for a Tunnel Boring Machine – at the time the largest ever used in construction.
			</p>
			<p>
			In order to provide sufficient working space for such a huge machine, we had to design the first cellular diaphragm wall cofferdam ever used in Hong Kong. This provided an open, strut free environment and has since been adopted by a number of other projects.
			</p>
		</div>
	</section>
</div>
<section class="fullbleed fullbleed--secondary fullbleed--hero" id="carouselTwo">
	<div class="progressiveMedia ">
		<div class="something">
            <img src="/images/arup-pages/hzmb/sail-columns.jpg" class="mainImg loading active fix-image" id="imageOne" alt="" width="2000" height="1125" disablewebedit="False">
            	<div class="caption__container">
            		<div class="image-caption" id="captionOne">This will be a caption that appears and disappears with the image</div>
            	</div>
            <img src="https://www.arup.com/-/media/arup/images/projects/h/hong-kong-zhuhai-macau-bridge/hong-kongzhuhaimacao-bridge--hong-kong-link-road--c-marcel-lam-photography.jpg?h=1125&amp;w=2000&amp;hash=060E3311B86D1EFCE1CC03CD7527CF2F" class="mainImg loading active fix-image" id="imageTwo" alt="" width="2000" height="1125" disablewebedit="False">
            <div class="caption__container">
            		<div class="image-caption" id="captionTwo">This will be a caption that appears and disappears with the image for the second one</div>
            	</div>
        </div>
    </div>
</section>
