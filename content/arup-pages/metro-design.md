...
<section class="fullbleed  fullbleed--hero fullbleed--project">
    ...
    <div class="progressiveMedia">
        ...
        <img src="https://www.arup.com/-/media/arup/images/projects/c/cityringen/copyright/r_hjortshoj---cityringen-test-48.jpg?h=1125&w=2000&hash=E17020EDC809E497A393043C584A390F" class="mainImg" alt="" width="2000" height="1125" DisableWebEdit="False" />;
    </div>
                ...
                <div class="col col__main">
                    <div class="page-info">
                        <div class="page-info__title feature-title">
                            <h3 class="feature-title__label">Service</h3>
                            <h1 class="feature-title__title">Metro rail design</h1>
                        </div>
                        <div class="page-info__content">
                            <P>Arup is really good at metro rail design. In essence, you want to use the word and associated words 'metro rail design' quite a bit here.</P>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="utility-bar sticky">
    <div class="container utility-bar__inner">
        ...
        <div class="utility-bar__breadcrumb">
            <p class="utility-bar__page-title">Metro rail design</p>
            <p class="utility-bar__page-subtitle">Talk to XXXX about this service</p>
        </div>
...
<P>Again this text will be contain lots of references to the words 'metro rail design' whilst remanining natural. The purpose of this page is to collate together our key metro rail projects and potentially perspectives and highlight our work in this area. So anyone that googles 'metro rail design' will have somewhere to land.</P>
<P>There is a question - and its just occurred to me - that what we're essentially doing here is creating another service page. But i don't necessarily think there's anything wrong with that. If doing this gets people on to the site exploring our content in an area of business importance then its a good thing?</P>
            </div>
        </div>
    </section>
            ...
            <div class="preview-card__main">
                <div class="preview-copy">
                    <a href="/perspectives/cities-alive-urban-childhood" class="preview-copy__toplink">
                        ...
                        <h3 class="preview-copy__title ">This is a metro project</h3>
